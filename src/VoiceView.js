      ...
      return (
        error ? (
          <View style={{ justifyContent: 'center', alignItems: 'center', width: 150, height: 150 }}>
            { errorIcon ? errorIcon : <Image source={require('./img/voiceError.png')} style={{ width: 60, height: 60 }} /> }
            <Text style={{ color: '#fff', marginTop: 10, textAlign: 'center' }}>{errorText}</Text>
          </View>
        ) : !voiceStatus ? (
          <View style={{ justifyContent: 'center', alignItems: 'center', width: 150, height: 150 }}>
            { cancelIcon ? cancelIcon : <Image source={require('./img/voiceCancel.png')} style={{ width: 60, height: 60 }} />}
...
VoiceView.defaultProps = {
  ...
  opacity: 1,
  voiceSpeakIcon: [
    require('./img/speak0.png'),
    require('./img/speak1.png'),
    require('./img/speak2.png'),
    require('./img/speak3.png'),
    require('./img/speak4.png'),
    require('./img/speak5.png'),
    require('./img/speak6.png'),
    require('./img/speak7.png'),
    require('./img/speak8.png'),
  ],
  voiceVolume: 10,
  sendVoice: () => {}
}